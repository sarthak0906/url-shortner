...
const TermsPage = () => (
  <BodyWrapper>
    <Wrapper>
      <h3>IOSD Terms of Service</h3>
      <p>
        By accessing the website at <a href="https://io.sd">https://io.sd</a>, you are agreeing
      ...
      <p>
        In no event shall IOSD or its suppliers be liable for any damages (including, without
        limitation, damages for loss of data or profit, or due to business interruption) arising out
        of the use or inability to use the materials on {"IOSD's"} website, even if IOSD or a IOSD
      ...
      <p>
        The materials appearing on IOSD website could include technical, typographical, or
        photographic errors. IOSD does not warrant that any of the materials on its website are
        accurate, complete or current. IOSD may make changes to the materials contained on its
        website at any time without notice. However IOSD does not make any commitment to update the
        materials.
      </p>
      <p>
        IOSD has not reviewed all of the sites linked to its website and is not responsible for the
        contents of any such linked site. The inclusion of any link does not imply endorsement by
        IOSD of the site. Use of any such linked website is at the {"user's"} own risk.
      </p>
      <p>
        IOSD may revise these terms of service for its website at any time without notice. By using
